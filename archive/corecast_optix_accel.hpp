...
class CoreCastOptixAccel {
 public:
   ...
   */
  CoreCastOptixAccel(OptixDeviceContext optixContext, const OptixAccelBuildOptions& build_options,
                     const std::vector<OptixBuildInput>& build_inputs, CUstream stream)
      : optixContext_(optixContext), stream_(stream), build_options_(build_options), build_inputs_(build_inputs) {
